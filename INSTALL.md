...
| # | 项目 | 是否必需 | 从哪里获得 | 用途 |
| --- | --- | --- | --- | --- |
| 1 | **`bg-skin-0.2.0.vsix`** | ✅ 必需 | 本仓库 [Releases 页面](https://github.com/sdh0219/bg-skin/releases) → 最新版本 → 展开 **Assets** → 点击下载 | 插件安装包（本体） |
...
```bash
git clone https://github.com/sdh0219/bg-skin.git
cd bg-skin
...
- 新版本发布在 [Releases 页面](https://github.com/sdh0219/bg-skin/releases)，更新方式 = 下载新 .vsix 重复第二节（无需先卸载）；
- 问题反馈请开 [Issue](https://github.com/sdh0219/bg-skin/issues)，附上输出面板（bg-skin 通道）的日志截图；
- 欢迎 Star ⭐ 支持更新动力。
